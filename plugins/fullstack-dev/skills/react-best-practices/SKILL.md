...
description: React architecture reference. Use when implementing, refactoring, or reviewing React TypeScript code that touches component composition, focused custom hooks, feature/shared boundaries, scoped state/providers, effect-driven state synchronization, API/data hooks, React 19 refs/context.
---
