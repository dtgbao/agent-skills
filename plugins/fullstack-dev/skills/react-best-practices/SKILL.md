...
description: React architecture reference. Use when implementing, refactoring, or reviewing React TypeScript code that touches component composition, focused custom hooks, feature/shared boundaries, scoped state/providers, effect-driven state synchronization, API/data hooks, React 19 refs/context, unit tests, or behavior-focused tests.
---
...
| Custom hooks or stateful UI logic               | HIGH     | `references/hooks-single-responsibility.md`                 |
| Provider scope or state ownership               | HIGH     | `references/state-scope-providers-to-owners.md`             |
| Synchronous state updates in effects            | HIGH     | `references/state-derive-without-effects.md`                |
