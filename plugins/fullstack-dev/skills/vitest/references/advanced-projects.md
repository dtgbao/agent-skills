...
- Inline projects inherit the root config by default; referenced config files and directories do not
- Set `extends: false` on an inline project when it must not inherit the root config
