...
defineConfig({
  test: {
    ...
    // Automatically clear mocks before each test (default: true in v5)
    clearMocks: true,
    
    // Restore spies created with vi.spyOn before each test
    restoreMocks: true,
...
- **v5 prerequisites** — Vite 6.4+ and Node.js 22.12+ are required.
- **`clearMocks` defaults to `true` in v5** — recorded calls, instances, contexts, and results are cleared before every test while implementations remain intact.
...
- v4 requires **Vite >= 6** and **Node >= 20**; v5 requires **Vite >= 6.4** and **Node >= 22.12**

<!-- 
Source references:
- https://vitest.dev/guide/#configuring-vitest
- https://vitest.dev/config/
- https://vitest.dev/guide/migration.html#migrating-to-vitest-5-0
-->
