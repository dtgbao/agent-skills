...
metadata:
  author: Anthony Fu
  version: "2026.8.12"
  source: Generated from https://github.com/vitest-dev/vitest and audited against Vitest 5.0.0-rc.1 source; scripts located at https://github.com/antfu/skills
---
...
- Configurable worker pools for parallel test execution
- Built-in coverage via V8 or Istanbul
- Snapshot testing, mocking, and spy utilities

> The skill targets the Vitest 5.x prerelease API and was audited against the
> `5.0.0-rc.1` source tree on 2026-08-12. Vitest 5 requires Vite 6.4+ and Node.js 22.12+.
