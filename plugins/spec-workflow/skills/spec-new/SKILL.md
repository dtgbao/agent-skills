...
- Requirements-First → [`spec-requirements`](../spec-requirements/SKILL.md)
- Design-First → [`spec-design`](../spec-design/SKILL.md)
- Bugfix → [`spec-bugfix`](../spec-bugfix/SKILL.md)
- Quick Spec → [`spec-quick`](../spec-quick/SKILL.md)
